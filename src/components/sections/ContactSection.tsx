  ...
  return (
    <section id="contact" className="py-24 bg-black relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 opacity-10">
        <div className="absolute top-1/3 right-1/3 w-64 h-64 rounded-full bg-purple-700 blur-[100px]" />
        <div className="absolute bottom-1/3 left-1/3 w-64 h-64 rounded-full bg-blue-700 blur-[100px]" />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-gray-300 text-lg">
            Have a project in mind or want to discuss potential opportunities? I would love to hear from you.
          </p>
        </motion.div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <div className="mr-4 p-3 bg-purple-500/10 rounded-lg">
                    ...
                    <div className="flex items-start">
                      <div className="mr-4 p-3 bg-blue-500/10 rounded-lg">
                    ...
                    <div className="flex items-start">
                      <div className="mr-4 p-3 bg-emerald-500/10 rounded-lg">
              ...
              <Card className="bg-gray-900/50 backdrop-blur-sm border-gray-800 overflow-hidden">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-300">
                    I am currently available for freelance work and open to discussing new opportunities.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="bg-gray-900/50 backdrop-blur-sm border-gray-800 overflow-hidden">
              <CardContent className="p-6">
                ...
                {isSubmitted ? (
                  ...
                  >
                    <div className="mx-auto w-12 h-12 flex items-center justify-center rounded-full bg-emerald-500/20 mb-4">
