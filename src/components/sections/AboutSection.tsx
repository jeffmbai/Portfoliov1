      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-gray-300 text-lg">
            ...
            React Native, TypeScript, and modern JavaScript frameworks, I build responsive, performant, and visually
            appealing applications that deliver exceptional user experiences.
          </p>
        </motion.div>
