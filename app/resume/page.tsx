            ...
            >
              ...
              <Card className="bg-gray-800/50 border-gray-700">
                <CardContent className="p-6 space-y-4">
                  <div>
                    <h3 className="font-semibold">Azure Developer Associate</h3>
                    <p className="text-gray-400 text-sm">Microsoft, 2022</p>
                  </div>
                  <div>
                    <h3 className="font-semibold">React Native Specialist</h3>
                    <p className="text-gray-400 text-sm">React Academy, 2021</p>
                  </div>
                  <div>
                    <h3 className="font-semibold">Advanced Frontend Development</h3>
                    <p className="text-gray-400 text-sm">Frontend Masters, 2020</p>
                  </div>
                </CardContent>
              </Card>
            </motion.section>
