      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          >
            <div className="relative h-full">
              ...
              <div className="relative h-full bg-black/80 backdrop-blur-md rounded-lg overflow-hidden border border-white/10">
        ...
        >
          <motion.div variants={itemVariants}>
            <Card className="bg-black/50 backdrop-blur-md border-gray-800 hover:border-purple-500/50 transition-all duration-300 h-full">
          ...
          <motion.div variants={itemVariants}>
            <Card className="bg-black/50 backdrop-blur-md border-gray-800 hover:border-blue-500/50 transition-all duration-300 h-full">
              <CardContent className="p-6 text-center">
          ...
          <motion.div variants={itemVariants}>
            <Card className="bg-black/50 backdrop-blur-md border-gray-800 hover:border-emerald-500/50 transition-all duration-300 h-full">
              <CardContent className="p-6 text-center">
          ...
          <motion.div variants={itemVariants}>
            <Card className="bg-black/50 backdrop-blur-md border-gray-800 hover:border-amber-500/50 transition-all duration-300 h-full">
              <CardContent className="p-6 text-center">
          ...
          <motion.div variants={itemVariants}>
            <Card className="bg-black/50 backdrop-blur-md border-gray-800 hover:border-rose-500/50 transition-all duration-300 h-full">
              <CardContent className="p-6 text-center">
          ...
          <motion.div variants={itemVariants}>
            <Card className="bg-black/50 backdrop-blur-md border-gray-800 hover:border-violet-500/50 transition-all duration-300 h-full">
              <CardContent className="p-6 text-center">
